...
// FIX: Fake para registerFallbackValue — mocktail requiere un valor
// concreto para tipos no-nullable usados con any()
class FakePackage extends Fake implements Package {}
 
void main() {
  // FIX: registrar fallback antes de cualquier test
  setUpAll(() {
