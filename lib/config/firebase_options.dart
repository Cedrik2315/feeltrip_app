...
class DefaultFirebaseOptions {
  static FirebaseOptions get currentPlatform {
    ...
    return FirebaseOptions(
      ...
      authDomain: dotenv.env['FIREBASE_AUTH_DOMAIN'] ?? 'feeltrip-demo.firebaseapp.com',
      databaseURL: dotenv.env['FIREBASE_DATABASE_URL'] ?? 'https://feeltrip-demo.firebaseio.com',
      storageBucket: dotenv.env['FIREBASE_STORAGE_BUCKET'] ?? 'feeltrip-demo.appspot.com',
    );
  }
