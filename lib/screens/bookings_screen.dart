      ...
      child: Column(
        ...
        children: [
          ...
          OutlinedButton(
            ...
            child: Text('EXPLORAR_MAPA', style: GoogleFonts.jetBrainsMono(color: const Color(0xFF1A1A1A))),
          ),
        ],
      ),
    );
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: TextButton(
                    ...
                    child: Text('>> VER_EXPEDICION', style: GoogleFonts.jetBrainsMono(color: const Color(0xFFF5F5DC))),
                  ),
                ),
              ],
            ),
